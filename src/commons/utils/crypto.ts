...
class Md5 {
    ...
    static RotateLeft(lValue: number, iShiftBits: number) {
        return (lValue << iShiftBits) | (lValue >>> (32 - iShiftBits));
    }

    static AddUnsigned(lX: number, lY: number) {
    ...
    static F(x: number, y: number, z: number) {
        return (x & y) | ((~x) & z);
    }

    static G(x: number, y: number, z: number) {
        return (x & z) | (y & (~z));
    }

    static H(x: number, y: number, z: number) {
        return (x ^ y ^ z);
    }

    static I(x: number, y: number, z: number) {
        return (y ^ (x | (~z)));
    }

    static FF(a: number, b: number, c: number, d: number, x: number, s: number, ac: number) {
        a = Md5.AddUnsigned(a, Md5.AddUnsigned(Md5.AddUnsigned(Md5.F(b, c, d), x), ac));
        return Md5.AddUnsigned(Md5.RotateLeft(a, s), b);
    }

    static GG(a: number, b: number, c: number, d: number, x: number, s: number, ac: number) {
        a = Md5.AddUnsigned(a, Md5.AddUnsigned(Md5.AddUnsigned(Md5.G(b, c, d), x), ac));
        return Md5.AddUnsigned(Md5.RotateLeft(a, s), b);
    }

    static HH(a: number, b: number, c: number, d: number, x: number, s: number, ac: number) {
        a = Md5.AddUnsigned(a, Md5.AddUnsigned(Md5.AddUnsigned(Md5.H(b, c, d), x), ac));
        return Md5.AddUnsigned(Md5.RotateLeft(a, s), b);
    }

    static II(a: number, b: number, c: number, d: number, x: number, s: number, ac: number) {
        a = Md5.AddUnsigned(a, Md5.AddUnsigned(Md5.AddUnsigned(Md5.I(b, c, d), x), ac));
        return Md5.AddUnsigned(Md5.RotateLeft(a, s), b);
    }

    static ConvertToWordArray(string: string) {
        let lWordCount;
    ...
    static WordToHex(lValue: number) {
